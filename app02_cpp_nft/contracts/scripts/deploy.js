 ...
 * BACKEND_MINTER_ADDRESS environment variable, so the locally-run C++ backend (ContractService)
 ...
 * The C++ backend does NOT read this file automatically in this phase — it has its own
