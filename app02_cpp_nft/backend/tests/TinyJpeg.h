...
// A real 16x16 JPEG (generated with Pillow) used as a fixture for EXIF watermark tests.
// 634 bytes.
namespace nftcerts::testsupport {

inline std::vector<unsigned char> tinyJpeg() {
    return {
    ...
    0x2a, 0x28, 0xa2, 0xbf, 0x32, 0x3f, 0xb8, 0xcf, 0xff, 0xd9,
    };
}
