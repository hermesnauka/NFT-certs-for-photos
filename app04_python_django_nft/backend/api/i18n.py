"""EN/PL message maps for GET /api/i18n/{lang}, generated verbatim from app01's
messages_en.properties / messages_pl.properties (same content as app02/app03's copies).
Regenerate from those files rather than editing by hand.
"""
...
ENGLISH = {
    ...
    "identity.verify.explainer": (
        "We confirm you are the rightful copyright holder of this photograph before any "
        "certificate can be minted in your name."
    ),
    ...
    "mint.hash.explainer": (
        "This SHA-256 hash is your artwork's unique digital fingerprint. It cryptographically "
        "proves the file has not been altered and links it to your certificate forever."
    ),
...
POLISH = {
    ...
    "mint.hash.explainer": (
        "Ten skrót SHA-256 to unikalny cyfrowy odcisk palca Twojego dzieła. Kryptograficznie "
        "dowodzi, że plik nie został zmieniony i na zawsze łączy go z Twoim certyfikatem."
    ),
