...
import com.devpowers.nftcerts.config.Web3Properties;
import com.devpowers.nftcerts.error.MintingException;
...
class ContractServiceTest {
    ...
    void mintCertificateMapsDuplicateContentHashRevertTo409StyleException() throws Exception {
        ...
        com.devpowers.nftcerts.error.DuplicateContentHashException exception =
                org.junit.jupiter.api.Assertions.assertThrows(
                        com.devpowers.nftcerts.error.DuplicateContentHashException.class,
                        () -> contractService.mintCertificate(RECIPIENT, METADATA_URI, CONTENT_HASH, ROYALTY_RECIPIENT, BigInteger.valueOf(750)));
